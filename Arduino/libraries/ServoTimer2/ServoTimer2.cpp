...
void ServoTimer2::write(int angleArg)
{
    ...
    p = (MIN_PULSE_WIDTH*16L*clockCyclesPerMicrosecond() + (MAX_PULSE_WIDTH-MIN_PULSE_WIDTH)*(16L*clockCyclesPerMicrosecond())*angle/180L)/8L;


   writeChan(this->chanIndex, p); // call the static function to store the data for this servo
}
